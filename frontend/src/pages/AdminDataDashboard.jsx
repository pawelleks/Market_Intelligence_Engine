...
const PIPELINE_STEPS = [
    ...
    { id: "Analytics", label: "Phase 3: Analytics", steps: ["Minervini Scanner", "Markov Grid", "Markov Snapshots", "HMM Grid", "Backtest HMM", "GEX", "Expected Moves", "Seasonality", "TSMOM", "GAF", "SMA/EMA Stack", "ADX/DMI", "Ichimoku", "PSAR", "VolatilityTermStructure", "AI Context Generation"] },
