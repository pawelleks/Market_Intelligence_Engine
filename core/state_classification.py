"""
Authoritative state classification module.

This module centralizes state classification logic used across the project.
See docs/state_classification.md for the canonical standard.
"""
