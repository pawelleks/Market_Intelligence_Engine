...
const ExpectedMovesPageMassive = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (!response.ok) {
                    ...
                    throw new Error(errJson.error || 'Failed to fetch expected moves data');
                }
    ...
    if (loading) return <div style={{ padding: '20px', color: '#d7e3f3' }}>Loading Massive Data...</div>;
    ...
    return (
        <div style={containerStyle}>
            ...
            <div style={leftPanelStyle}>
                ...
                <div style={boxStyle}>
                    ...
                    <p style={{ fontSize: '12px', color: '#d7e3f3', lineHeight: '1.4' }}>
                        Expected Moves are calculated using ATM Straddle prices from Massive.com.
                    </p>
                </div>
            </div>
            ...
            <div style={rightPanelStyle}>
                <h2 style={{ fontSize: '1.5rem', marginBottom: '0', color: '#d7e3f3' }}>Expected Moves (Massive)</h2>
                ...
                {selectedTicker && tickers[selectedTicker] && (
                    <div style={{
                        ...
                        <div style={{ fontWeight: 'bold', color: '#d7e3f3', marginBottom: '5px' }}>Debug Details (Massive)</div>
                            ...
                            {['ODTE', 'WEEKLY', 'MONTHLY'].map(type => {
                                ...
                                return (
                                    <div key={type}>
                                        ...
                                        <div>Call: {debug.call_ticker} (${debug.call_price})</div>
                                        <div>Put:  {debug.put_ticker} (${debug.put_price})</div>
...
export default ExpectedMovesPageMassive;
