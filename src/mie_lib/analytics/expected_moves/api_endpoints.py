...
async def get_static_expected_moves():
    """
    Serves pre-computed static EM from JSON (instant, no live computation).
    Generated by jobs/process_expected_moves_static.py (cron or startup).
    """
    import json
...
async def get_theta_expected_moves(ticker: str):
    """
    Returns Expected Moves Calculated Live from ThetaData (Via 25510).
    Independent of Massive/yfinance.
    """
    import os
