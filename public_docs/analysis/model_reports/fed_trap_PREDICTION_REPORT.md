...
| **Avg 12m Return After Signal** | 9.9% | ⚠️ Blow-off Top Pattern |
...
- **Hit Rate**: 0.0% (0 of 3 recessions predicted)
...
**False Positive Rate**: 100.0% (3 of 3 signals)
...
|--------------|----------------|-----|-----|
| **6 Months** | 17.3% | 13.9% | 22.6% |
| **12 Months** | 9.9% | -15.1% | 28.0% |
| **24 Months** | 15.7% | -1.0% | 39.3% |

### Drawdown Analysis

- **Average Max Drawdown**: -9.6%
- **Worst Drawdown**: -22.9%
- **Average Time to Bottom**: 11.6 months

### Blow-off Top Analysis

**Blow-off Tops Detected**: 3 out of 3 signals (100.0%)

⚠️ **High Blow-off Top Rate**: Markets rallied **32.2% on average** in the **12.7 months** after this model signaled TROUBLE before eventually declining.
...
**TROUBLE Periods**: 89 (27.4% of time)  
**WARNING Periods**: 16  
**CLEAR Periods**: 220
...
- ⚠️ Limited historical data (27 years) - fewer recessions to validate against
